export const recipes = [
  {
    ...
    plannerIngredients: [
      ...
      { ingredientId: 3, amount: 1 },
      { ingredientId: 1, amount: 1 },
      { ingredientId: 4, amount: 2 },
      { ingredientId: 5, amount: 1 },
      { ingredientId: 6, amount: 200 },
      { ingredientId: 7, amount: 0.25 },
      { ingredientId: 8, amount: 1 },
      { ingredientId: 9, amount: "Handful" },
  ...
  },
  {
    ...
    plannerIngredients: [
      { ingredientId: 11, amount: 140 },
      { ingredientId: 4, amount: 2 },
      { ingredientId: 12, amount: 1 },
      { ingredientId: 0, amount: 1 },
      { ingredientId: 3, amount: 1 },
      { ingredientId: 14, amount: 2 },
      { ingredientId: 25, amount: 1 },
      { ingredientId: 13, amount: 3 },
      { ingredientId: 15, amount: 100 },
      { ingredientId: 26, amount: "Half a bunch" },
      { ingredientId: 16, amount: "Handful" },
    ],
    method: [
  ...
  },
  {
    ...
    plannerIngredients: [
      ...
      { ingredientId: 20, amount: 3 },
      { ingredientId: 1, amount: 2 },
      { ingredientId: 21, amount: 200 },
      { ingredientId: 26, amount: "Thumb-sized piece" },
      { ingredientId: 2, amount: 1 },
      { ingredientId: 10, amount: 1.5 },
      { ingredientId: 23, amount: 2 },
      { ingredientId: 24, amount: 0.25 },
      { ingredientId: 9, amount: "Half a small pack" },
    ],
    method: [
